...
def AkshayTitanicLogistic():
    ...
    countplot(data=titanic_data,x=target).set_title("Akshay Chandilkar :Survived and non survied passangers")
    show()
    ...
    countplot(data=titanic_data,x=target, hue="Sex").set_title("Akshay Chandilkar: Survived and non survied passangers based on Gender")
    show()
    ...
    countplot(data=titanic_data,x=target, hue="Pclass").set_title("Akshay Chandilkar: Survived and non survied passangers based on the Passanger class")
    show()

    print("Visualisation: Survived and non survied passangers based on Age")
    figure()
    titanic_data["Age"].plot.hist().set_title("Akshay Chandilkar: Survived and non survied passangers based on Age")
    show()

    print("Visualisation: Survived and non survied passangers based on the Fare")
    figure()
    titanic_data["Fare"].plot.hist().set_title("Akshay Chandilkar: Survived and non survied passangers based on Fare")
    show()
